      ...
      <div className="mb-8 flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <h3 className="font-display text-4xl text-radiant-white sm:text-5xl">
            The collective covenant is already in motion.
          </h3>
        </div>
        <p className="max-w-md text-base leading-8 text-[rgba(245,245,245,0.68)]">
          ...
          is connected, this wall updates from real declaration activity.
        </p>
      </div>
      ...
      <div className="grid gap-x-8 gap-y-5 sm:grid-cols-2 xl:grid-cols-3">
        {entries.map((entry, index) => (
          ...
          >
            ...
            <p className="mt-1 text-sm leading-6 text-[rgba(245,245,245,0.66)]">{entry.subtitle}</p>
          </motion.div>
        ))}
      </div>
    </div>
